...
def main():
    ...
    try:
        with socketserver.TCPServer(("", PORT), Handler) as httpd:
            ...
            print(f"  🎨 PowerPoint Generator: http://localhost:{PORT}/index.html")
            print()
            print("🛠️ PowerPoint Generator Features:")
            ...
            try:
                ...
                print(f"Please navigate to: http://localhost:{PORT}/index.html")
